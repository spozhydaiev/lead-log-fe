...
it('marks Summaries active',()=>{path='/summaries/summary_1';render(<AppShell><p>Content</p></AppShell>);expect(screen.getByRole('link',{name:'Summaries'})).toHaveClass('active');});
